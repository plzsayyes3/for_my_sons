const CACHE_NAME = 'for-my-sons-v58';
const SHELL = [
  './',
  './index.html',
  './styles.css',
  ...
  './shared/for-my-sons.js?v=8',
  './shared/settings-view.js?v=6',
  './shared/for-my-sons.css?v=3',
  './kids-3d-playgrand/?v=3',
  './kids-3d-playgrand/index.html?v=3',
  './kids-3d-playgrand/manual.html?v=3',
  './piano/?v=14',
  ...
  './shared/official-wankos.js?v=7',
  './shared/wanko-library.js',
  './shared/wanko-game-data.js?v=2',
  './shared/wanko-game-progress.js?v=4',
