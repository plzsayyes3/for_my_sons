const CACHE_NAME = 'for-my-sons-v48';
const SHELL = [
  './',
  './index.html',
  './styles.css',
  ...
  './shared/parent-lock.js?v=2',
  './shared/save-store.js?v=1',
  './shared/github-sync.js?v=3',
  './shared/character-requests.js?v=1',
  './shared/for-my-sons.js?v=3',
  './shared/settings-view.js?v=2',
  './shared/for-my-sons.css?v=2',
  './piano/?v=14',
